...
1. **创建基本的 HTML 结构**：
   ...
   document.addEventListener("DOMContentLoaded", function() {
       ...
       var operationInputs = document.getElementsByName('operation');
   ...
   **编写 JavaScript 脚本：**
   ...
   document.addEventListener("DOMContentLoaded", function() {
       ...
       function updateWeatherWidget(data) {
           var locDiv = document.querySelector('.weather-loc');
           var humidityDiv = document.querySelector('.weather-humidity');
           var tempDiv = document.querySelector('.weather-temp');
           var tomorrowImg = document.querySelector('.weather-tomorrow');
           var dayAfterImg = document.querySelector('.weather-dayaftertomorrow');
           ...
           var tomorrowImgUrl = 'http://us.yimg.com/i/us/nws/weather/gr/' + tomorrowCode + 'ds.png';
           var dayAfterImgUrl = 'http://us.yimg.com/i/us/nws/weather/gr/' + dayAfterCode + 'ds.png';
